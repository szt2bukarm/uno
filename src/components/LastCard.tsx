...
function LastCard() {
    const { currentPlayer,hostID,playerID,drawCard,playersCards,lobbyId,onlineMatch,setAttackedPlayerID,setAttackAmount,setLastCardName,setLastCardPlayer,playerNo,lastCardAttack,lastCardName,lastCardPlayer,setCurrentPlayer,setLastCardAttack } = useStore();
    ...
    useEffect(() => {
        ...
        if (lastCardPlayer == playerNo && lastCardAttack) {
            const timeout = setTimeout(() => {
                setAttackedPlayerID(lastCardPlayer);
                setAttackAmount(2);
                endRound();
    ...
    if (onlineMatch) {
        lastCardAttackOnline(lobbyId,lastCardPlayer,playerNo);
    }
